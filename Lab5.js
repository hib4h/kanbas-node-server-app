...
const module = {
  ...
  const todos = [
    { id: 1, title: "Task 1", description: "Create assignment", completed: false },
    { id: 2, title: "Task 2", description: "Create module", completed: true },
    { id: 3, title: "Task 3", description: "Create todos", completed: false },
    { id: 4, title: "Task 4", description: "Add to route", completed: true },
  ];  
